...
public class PersonOnBoard extends JPanel {
    ...
    public PersonOnBoard(View view) {
        ...
        final JTextField totalPeople = new JTextField(
                "Numero di perone totali:" + view.getController().seeNumberPeople());
        totalPeople.setFont(new Font(FONT, Font.PLAIN, 16));
        totalPeople.setSize(10,20);
